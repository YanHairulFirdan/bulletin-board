...
<body style="width: 60%; margin: auto;">
    <div class="container">
        <?php if (isset($viewVariables['errorMessages'])) : ?>
            <ul style="width: inherit; padding: 2em; color: #fff; background-color: red;">
                <?php foreach ($viewVariables['errorMessages'] as $message) : ?>
                    <li>
                        <?= $message ?>
                    </li>
                <?php endforeach; ?>
        ...
        <form action="" method="POST" style="padding: 2em;">
            <div class="form-input" style="width: inherit;">
                ...
                <div class="input-field">
                    <input type="text" name="title" style="display: inline-block; width: 100%; height: 2em;" style id="title" value="<?= isset($_POST['title']) ? $_POST['title'] : '' ?>">
                </div>
            </div>
            <div class="form-input" style="width: inherit;">
                <div class="input-title" style="margin: 2em 0;">
                ...
                <div class="input-field">
                    <textarea name="body" id="body" style="display: inline-block; width: 100%; height: 4em;" style><?= isset($_POST['body']) ? $_POST['body'] : '' ?></textarea>
                </div>
            </div>
    ...
    <?php foreach ($viewVariables['bulletins'] as $key => $bulletin) : ?>
